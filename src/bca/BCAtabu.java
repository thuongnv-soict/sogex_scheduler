...
public class BCAtabu {
    private static final String  fileInput="BCArandom.txt";
    private static final String  fileOutput="BCA.html";
...
class Classes implements Comparable{

    public int classID;
    public int courseiD;
    public int[] slot;
    public int weight;
    public Classes(int classID, int courseiD, int[] slot) {
        this.classID = classID;
        this.courseiD = courseiD;
        this.slot = slot;
        this.weight=slot.length;
    }
    

    @Override
    public int compareTo(Object o) {
        int compareage=((Classes)o).weight;
        /* For Ascending order*/
        return compareage-this.weight; //To change body of generated methods, choose Tools | Templates.
    }
}
...
class Instructor {
    ...
    public String name;
    public int[] busySlot;
    public int[] courseIDTeached;

    public Instructor(int ID, String name, int[] busySlot,int[] courseIDTeached) {
        this.instructorID = ID;
        this.name = name;
        this.busySlot = busySlot;
        this.courseIDTeached=courseIDTeached;
    }
}
